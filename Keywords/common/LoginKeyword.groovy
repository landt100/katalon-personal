...
public class LoginKeyword {
	static void login (String email, String password) {
		...
		WebUI.click(findTestObject('Object Repository/Login/btn_password'))
		WebUI.waitForPageLoad(30)
		WebUI.verifyElementText(findTestObject('Object Repository/Login/home_page_title'), 'Bảng điều khiển')
	}
}
